...
public class Math3D {
    ...
    public static Quisition getIntersectionPoint(Quisition planePos, Quisition planeNormal, Quisition start, Quisition end) {
        ...
        return new Quisition(end.x + point.x*t, end.y + point.y*t, end.z + point.z*t, end.w + point.w*t, end.t.u + (start.t.u - end.t.u)*t, end.t.v + (start.t.v - end.t.v)*t);
    }

    public static double getIntersectionPointT(Quisition planePos, Quisition planeNormal, Quisition start, Quisition end) {
        Quisition point = new Quisition(start);
        point.subtract(end);
        double d = getDotProduct(planeNormal, planePos);
        return (d - getDotProduct(planeNormal, end)) / getDotProduct(planeNormal, point);
    }
